...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("job_validated", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("pains_validated", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("gains_validated", sa.Boolean(), nullable=False, server_default=sa.text("false")),
